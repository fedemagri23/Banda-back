...
## Reglas CRÍTICAS para tipos de datos
- NUNCA mapees valores como "100-8310", "ABC-123", códigos con guiones o letras a campos INTEGER
- Los campos INTEGER solo aceptan números enteros puros como 1, 2, 100, 500
- Si un valor contiene letras, guiones, o caracteres especiales, debe ir a un campo VARCHAR/TEXT
- Los campos numéricos (NUMERIC) pueden tener decimales pero NO letras ni guiones


## Reglas CRÍTICAS para el tipo ADDRESS
- Para el campo 'address', usa OBLIGATORIAMENTE la sintaxis: ROW($param1, $param2, $param3, $param4, $param5, $param6, $param7)::address
- NUNCA uses solo ROW() sin el casting ::address
- El tipo address tiene exactamente 7 campos en este orden: town, street, number, floor, departament, zip_code, observations

## Ejemplo correcto para address:
Si tienes una dirección "Werner-von-Siemens-Straße 1, 80333 Munich", la query debe ser:
INSERT INTO supplier (name, country, address, company_id) 
VALUES ($1, $2, ROW($3, $4, $5, $6, $7, $8, $9)::address, $10);

Donde:
- $3 = 'Munich' (town)
- $4 = 'Werner-von-Siemens-Straße' (street)  
- $5 = '1' (number)
- $6 = null (floor)
- $7 = null (departament)
- $8 = '80333' (zip_code)
- $9 = null (observations)
    ...
    ## Reglas importantes
    - El parametro adress debe ser un objeto compuesto con los campos: town, street, number, floor, departament, zip_code, observations
